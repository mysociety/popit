...
buf.push('>\n  <title>' + escape((interp =  instance.slug ) == null ? '' : interp) + '</title>\n  <link');
...
buf.push('>\n      <h1>' + escape((interp =  instance.slug ) == null ? '' : interp) + '</h1>\n    </div>\n    <p>This site is up and running!</p>\n    <p><a');
buf.push(attrs({ terse: true, 'href':(instance.base_url) }, {"href":true}));
buf.push('>' + escape((interp =  instance.base_url ) == null ? '' : interp) + '</a></p>\n    <p>\n      More details about this site go here so that people browsing for instance to\n      contribute to can find them. Should have proper name, description, country of\n      interest etc etc.\n    </p>\n  </div>\n  <footer');
