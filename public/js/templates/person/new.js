...
buf.push('>\n      <div');
buf.push(attrs({ terse: true, 'id':('person_new_name') }, {}));
buf.push('>\n        <label>Name</label>\n        <input');
buf.push(attrs({ terse: true, 'name':("name"), 'value':(person.name) }, {"name":true,"value":true}));
buf.push('>');
if ( errors.name)
{
buf.push('<span');
...
{
buf.push('\n      <p');
buf.push(attrs({ terse: true, 'id':('person_new_slug') }, {}));
buf.push('>\n        <label>Slug</label>\n        <input');
buf.push(attrs({ terse: true, 'name':("slug"), 'value':(person.slug) }, {"name":true,"value":true}));
buf.push('><span');
...
buf.push('\n      <input');
buf.push(attrs({ terse: true, 'type':("submit"), 'value':("Create new person"), "class": ("btn") }, {"type":true,"class":true,"value":true}));
buf.push('>\n    </form>\n  </div>\n  <footer');
