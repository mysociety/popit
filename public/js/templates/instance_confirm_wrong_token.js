...
buf.push('>\n  <title>Wrong token for ' + escape((interp =  instance.slug ) == null ? '' : interp) + '</title>\n  <link');
...
buf.push('>\n      <h1>' + escape((interp =  instance.slug ) == null ? '' : interp) + '</h1>\n    </div>\n    <h2>Wrong confirmation token</h2>\n    <p>The token you have is wrong, please check it and try again.</p>\n  </div>\n  <footer');
