...
buf.push('>\n  <title>Confirm ' + escape((interp =  instance.slug ) == null ? '' : interp) + '</title>\n  <link');
...
buf.push('>\n      <p>\n        <input');
buf.push(attrs({ terse: true, 'type':('submit'), 'name':('elected'), 'value':('a politician in an elected assembly'), "class": ("btn") }, {"type":true,"class":true,"name":true,"value":true}));
buf.push('>\n      </p>\n      <p>\n        <input');
buf.push(attrs({ terse: true, 'type':('submit'), 'disabled':(true), 'value':('a president, prime minister, dictator or supreme leader'), "class": ("btn") }, {"type":true,"class":true,"disabled":true,"value":true}));
buf.push('>\n      </p>\n      <p>\n        <input');
buf.push(attrs({ terse: true, 'type':('submit'), 'disabled':(true), 'value':('a candidate for election to an assembly'), "class": ("btn") }, {"type":true,"class":true,"disabled":true,"value":true}));
buf.push('>\n      </p>\n      <p>\n        <input');
buf.push(attrs({ terse: true, 'type':('submit'), 'disabled':(true), 'value':('an elected public servant (judge, sheriff)'), "class": ("btn") }, {"type":true,"class":true,"disabled":true,"value":true}));
buf.push('>\n      </p>\n      <p>\n        <input');
buf.push(attrs({ terse: true, 'type':('submit'), 'disabled':(true), 'value':('other - create your own custom position'), "class": ("btn") }, {"type":true,"class":true,"disabled":true,"value":true}));
buf.push('>\n      </p>\n    </form>\n  </div>\n  <footer');
