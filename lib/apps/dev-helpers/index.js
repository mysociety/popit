...
console.log("");
console.log("**************************************************************");
console.log("* WARNING - the dev helpers have been activated. This means  *"); 
console.log("* that anyone going to '/_dev' will be able to delete        *");
console.log("* instances. If this is not a dev or test server you should  *");
console.log("* change NODE_ENV to 'production' or similar.                *");
console.log("**************************************************************");
console.log("");
