...
module.exports = function (opts) {
  ...
  app.get(  '/:id(*)/images/upload', requirePermission('can_edit_instance'), image.upload_image );
  app.post( '/:id(*)/images/upload', requirePermission('can_edit_instance'), image.upload_image );
  app.get(  '/images/:image_spec/:id(*)', image.get );
  app.post( '/images/:image_spec/:id(*)/delete', requirePermission('can_edit_instance'), image.delete );
