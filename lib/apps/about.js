...
module.exports = function () {
  ...
  var fields = {
    "allow_guest_access": { type: "checkbox", label: "Allow guest editing"             },
  ...
  app.get('/edit', requirePermission('can_edit_instance'), function (req,res) {
    fields = load_about_settings(req);
    res.locals.fields = fields;
    res.render('about/edit.html');
  });
  
  app.post('/edit', requirePermission('can_edit_instance'), function(req, res, next) {
