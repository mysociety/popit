var check      = require('validator').check,
    ...
    async      = require('async'),
    fixtures   = require('pow-mongodb-fixtures'); // FIXME - should use proper npm package once pull request accepted
...
module.exports.extract_slug = function extract_slug ( hostname, suffix ) {
    
    var index = hostname.indexOf( '.' + suffix);
